...
SRC_URI:append = " \
	file://0009-dts-renesas-Disable-ETH3-pin-setting.patch \
	file://0010-dts-renesas-reserve-memory-for-CA55-resource-table.patch \
"
...
KERNEL_DEVICETREE += " \
	${@'renesas/r9a09g087m44-dev-fsp-a551-support.dtb \
	renesas/r9a09g087m44-dev-fsp-a552-support.dtb \
	renesas/r9a09g087m44-dev-fsp-a553-support.dtb' if d.getVar('RPMSG_REMOTE_CORE') == '1' else ''} \
"
