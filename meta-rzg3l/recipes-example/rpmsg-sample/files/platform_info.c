...
struct mbx_channel chn_info[MBX_CH_NUM] ={
	{3, 3, INT_MHU_RSP_CH3_NS},
};

/** This strucure array is initilized in rz_proc_init() */ 
...
/* processor operations at RZ/G3. It defines
